...
<header class="hero-section" id="hero">
    <div class="hero-content">
        ...
        <div class="cta-buttons">
            <a href="/Aunt_Joy_Restaurant/views/customer/menu.php" class="btn btn-primary">Order Now</a>
        </div>
                    ...
                    <article class="menu-preview-card">
                        <div class="preview-media">
                            <?php if (!empty($meal['image_url']) && strpos($meal['image_url'], '/') !== false): ?>
                                <img src="/Aunt_Joy_Restaurant/<?php echo $meal['image_url']; ?>" alt="<?php echo htmlspecialchars($meal['meal_name']); ?>">
                            <?php else: ?>
                        ...
                        <div class="preview-body">
                            ...
                            <a href="/Aunt_Joy_Restaurant/views/customer/menu.php" class="preview-link">View meal →</a>
                        </div>
                    </article>
                <?php endforeach; ?>
            </div>
...
<section class="cta-strip">
    <div class="cta-strip-content">
        ...
        <a href="/Aunt_Joy_Restaurant/views/customer/menu.php" class="btn btn-primary">Browse Menu</a>
    </div>
</section>
...
<section class="contact-section" id="contact">
    <div class="contact-card">
        ...
        <div class="contact-actions">
            ...
            <button onclick="openAuthModal('register')" class="btn btn-secondary">Partner with us</button>
        </div>
    </div>
</section>
